...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Happy Home — Sri Lankan & Indian Restaurant" },
      { name: "description", content: "Premium Sri Lankan and Indian dining. Order, reserve, and earn loyalty rewards." },
      { name: "apple-mobile-web-app-capable", content: "yes" },
      { name: "apple-mobile-web-app-status-bar-style", content: "black-translucent" },
      { name: "apple-mobile-web-app-title", content: "Happy Home" },
      { property: "og:title", content: "Happy Home Restaurant" },
      { property: "og:description", content: "Premium Sri Lankan + Indian dining, delivered." },
