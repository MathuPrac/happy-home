...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "A modern, minimal table for the soulful flavours of Sri Lanka and India." },
      { name: "author", content: "Happy Home Restaurant" },
      { property: "og:site_name", content: "Happy Home Restaurant" },
