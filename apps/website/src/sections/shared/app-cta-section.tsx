    ...
    <section className="container-luxe py-24">
      ...
      >
        <div
          ...
          style={{
            background:
              'radial-gradient(ellipse at top, hsl(var(--gold) / 0.2) 0%, transparent 60%)',
          }}
        />
          ...
          <div className="relative h-72 md:h-96">
            ...
            >
              <div className="relative h-full w-48 rounded-3xl border-4 border-gold/30 bg-gradient-to-br from-background to-card p-3 shadow-luxe">
                <div className="flex h-full w-full flex-col items-center justify-center gap-3 rounded-2xl bg-gradient-to-br from-card via-background to-card px-3">
                  ...
                  <div className="mt-3 flex h-8 w-full items-center justify-center rounded-sm bg-gold/90 text-[10px] uppercase tracking-[0.2em] text-primary-foreground">
                    Confirmed
                  </div>
                </div>
              </div>
